...
import CO2 from "./CO2_T2";
import SO2 from "./SO2_T2";
import NO2 from "./NO2_T2";
import NO from "./NO_T2";
import CO from "./CO_T2";
import H2S from "./H2S_T2";
...
class Terminal2 extends React.Component {
    ...
    componentDidMount() {
        this.fetchData();
        document.title = "Terminal 2";
    }

    fetchData = async () => {
        try {
            const response = await axios.get('http://localhost:8080/api/terminal2');
        ...
        return (
            <>
                <div className="terminal-background">
                    <div style={{ position: 'absolute', top: '50px', left: '600px' }}>Terminal 2  </div>
