...
import CO2 from "./CO2_T3";
import SO2 from "./SO2_T3";
import NO2 from "./NO2_T3";
import NO from "./NO_T3";
import CO from "./CO_T3";
import H2S from "./H2S_T3";
import Timer from "../Timer";
import axios from 'axios';
import '../Terminal.scss';
class Terminal3 extends React.Component {
    state_show = {
        id: 3,
        CO2: [
            { time: '', CO2: '' },
    ...
    componentDidMount() {
        this.fetchData();
        document.title = "Terminal 3";
    }

    fetchData = async () => {
        try {
            const response = await axios.get('http://localhost:8080/api/terminal3');
        ...
        return (
            <>
                <div className="terminal-background">
                    <div style={{ position: 'absolute', top: '50px', left: '600px' }}>Terminal 3  </div>
